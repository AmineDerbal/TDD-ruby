...
Simple ruby exercice that consist of creating the tests of all methods of the solver class first before implementing the class itself  
...
<ul>
<li>cd my-folder</li>
<li>git clone https://github.com/AmineDerbal/TDD-ruby.git</li>
</ul>
...
Feel free to check the [issues page](https://github.com/AmineDerbal/TDD-ruby/issues).
